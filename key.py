def Subscraption():
	key1=open('/data/data/com.termux/files/usr/bin/.xce-cov', 'r').read()
	clear()
	print(logo)
	r1=requests.get("https://www.facebook.com/md12qw").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m 🆂🅷🅸🅿🅾🅽 Toll Paid You Need Get Approved First\033[1;37m\n")
		...
		print ("")
		print (" Your Key : "+mrs+shipon+key1)
		print ("")
		...
		os.system('am start https://wa.me/+8801773276144?text=' + tks)
		Subscraption()        
Subscraption()